...
$pagetitle1 = "Your order from \"$sitename\"";
//-----------------------------------------------message for Pinat
$message .= "
<html>
	<head></head>
...
<html>
	...
	<p><strong>Second Name:</strong> $surname </p>
	<p><strong>Phone:</strong> $phone  </p>
	<p><strong>e-mail:</strong> $email</p>
	<p><strong>Adress:</strong> $adress</p>
	<p><strong>Payment method:</strong> $paymentMethod</p>
	<p><strong>Delivery method:</strong> $order_delivery</p>
	<strong>Order:</strong>
</body>
</html>
";
...
$result=mysqli_query($db,"SELECT * FROM cart,goods WHERE cart.cart_ip ='{$_SERVER['REMOTE_ADDR']}' AND goods.goods_id = cart.cart_id_product");
		...
		while ($myrow = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
				{		
					echo $goods_name=$myrow["goods_name_en"];
				...
				$messageCl .="<p><strong>Order price:</strong> $total_sum UAH</p>";
