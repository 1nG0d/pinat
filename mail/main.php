...
$pagetitle1 = "Ваше замовлення на \"$sitename\"";
//-----------------------------------------------message for Pinat
$message .= "
<html>
	<head></head>
	...
	<p><strong>Коментар:</strong> $comm </p>
...
<html>
	<head></head>
	<body>
	<p><strong>Номер Вашого замовлення:</strong> $order_id</p>
	<p><strong>Ім'я:</strong> $name </p>
	<p><strong>Прізвище:</strong> $surname </p>
	<p><strong>Телефон:</strong> $phone  </p>
	<p><strong>e-mail:</strong> $email</p>
...
$result=mysqli_query($db,"SELECT * FROM cart,goods WHERE cart.cart_ip ='{$_SERVER['REMOTE_ADDR']}' AND goods.goods_id = cart.cart_id_product");
		...
		while ($myrow = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
				{		
					echo $goods_name=$myrow["goods_name"];
				...
				$messageCl .="<p><strong>Сума замовленння:</strong> $total_sum грн.</p>";
